		...
		<div class="modal-body modalTitulo">
			...
			<div class="contenidoCheckout">
				...
				<div class="formEnvio row">
					...
					<h4 class="text-center well text-muted text-uppercase" style="display:none;">Información de envío </h4>

					<div class="col-xs-12 seleccionePais" style="display:none;">
				...
				<div class="formaPago row">
					...
					<figure class="col-xs-6" style="display:none;">
					...
					<div class="col-sm-6 col-xs-12 pull-right">
						...
						<table class="table table-striped tablaTasas">
							...
							<tbody>
								...
								<tr>
									<td>Envío</td>	
									<td><span class="cambioDivisa">USD</span> $<span class="valorTotalEnvio" valor="2">2.00</span></td>	
								</tr>
