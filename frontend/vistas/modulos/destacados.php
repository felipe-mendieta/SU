...
$servidor = Ruta::ctrRutaServidor(); #ruta del servidor para backend
...
if($titulosModulos[0] == "ARTÍCULOS GRATUITOS"){ #pide articulos mas gratis
...
if($titulosModulos[1] == "LO MÁS VENDIDO"){ 	#pide articulos mas vendidos
...
if($titulosModulos[2] == "LO MÁS VISTO"){ #pide articulos mas vistos
